  ...
  '<div class="top-bar">' +
    '<div class="container-fluid">' +
      '<div class="row">' +
        ...
        '</div>' +
        '<div class="citation">' +
            Ce site est conçu dans le cadre d’un projet d’étude universitaire.
            Il n’a pas de vocation commerciale et est consultable gratuitement.
            Pour toute information ou réclamation, vous pouvez nous contacter à l’adresse suivante :
            watchnewsapp@gmail.com
        '</div>' +
      '</div>' +
    '</div>' +
  '</div>' +
